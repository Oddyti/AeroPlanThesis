...
\begin{center}
    \bfseries \zihao{3}
    \linespreadsingle{}
    \begin{tabularx}{.9\textwidth}{>{\fangsong}l X<{\centering}}
        ...
        }
        {
            ...
            {
                % TitleEngLines == 3
                英文论文题目：& \zihao{4} \uline{\hfill \TitleEngLineOne{} \hfill} \\
                ~            & \zihao{4} \uline{\hfill \TitleEngLineTwo{} \hfill} \\
                ~            & \zihao{4} \uline{\hfill \TitleEngLineThree{} \hfill} \\
            }
        }
    \end{tabularx}
\end{center}
